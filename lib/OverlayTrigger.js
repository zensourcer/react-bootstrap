...
class OverlayTrigger extends _react.default.Component {
  ...
  render() {
    ...
    return _react.default.createElement(_react.default.Fragment, null, (0, _react.cloneElement)(child, triggerProps), _reactDom.default.createPortal(this._overlay, this._mountNode));
  }
