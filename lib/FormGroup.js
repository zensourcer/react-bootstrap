...
class FormGroup extends _react.default.Component {
  ...
  hasFeedback(children) {
    return _ValidComponentChildren.default.some(children, child => (0, _bootstrapUtils.getChildProp)(child, 'bsRole') === 'feedback' || child.props.children && this.hasFeedback(child.props.children));
  }
